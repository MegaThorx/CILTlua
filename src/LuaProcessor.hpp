...
public:
	...
	*/
	...
	void onMemberVariableDeclaration(CIL::Value obj, CIL::Value field, CIL::Value normal, DeclarationType declarationType)
	{
		switch(declarationType)
		{
			case DeclarationType::NORMAL_TO_MEMBER:
				addTransCompData("local " + obj.toString() + "." + field.toString() + " = " + normal.toString() + "\n");
				break;
			case DeclarationType::MEMBER_TO_NORMAL:
				addTransCompData("local " + normal.toString() + " = " + obj.toString() + "." + field.toString() + "\n");
				break;
		}
	}

	void onMemberVariableAssignment(CIL::Value obj, CIL::Value field, CIL::Value normal, AssignmentType assignmentType)
	{
		switch(assignmentType)
		{
			case AssignmentType::NORMAL_TO_MEMBER:
				addTransCompData(obj.toString() + "." + field.toString() + " = " + normal.toString() + "\n");
				break;
			case AssignmentType::MEMBER_TO_NORMAL:
				addTransCompData(normal.toString() + " = " + obj.toString() + "." + field.toString() + "\n");
				break;
		}
	}
private:
